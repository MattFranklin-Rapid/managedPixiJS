...
export type ActorStateNames = 'idle'

export type ActorState = {
    state: ActorStateNames,
...
export class Actor extends Container{
    ...
    /**
     * Instantiate the actor. Will automatically add its active sprite as a child to the parent context if possible
     * @param parent 
     */
    constructor(parent?: Container, initialStates?: ActorState[], startingState?: ActorStateNames){
        super();
     ...
     */
    getStateByName(stateName: string): ActorState|undefined{
